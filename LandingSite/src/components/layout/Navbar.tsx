...
export function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-8 right-8 z-50 flex items-center bg-[#111111] shadow-2xl rounded-full p-1.5 border border-white/10"
    >
      ...
      <div className="relative">
        <Magnetic>
          <button 
            ...
            className="flex items-center gap-2 bg-[#037cf9] text-white px-5 py-2.5 font-bold text-sm cursor-pointer hover:bg-blue-600 transition-colors rounded-full"
          >
      ...
      {/* Other Links */}
      <div className="flex items-center gap-6 px-8 text-white/70 text-sm font-medium">
